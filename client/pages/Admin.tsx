          ...
          <div className="p-6">
            ...
            {saveStatus !== 'idle' && (
              <div className="fixed top-6 right-6 z-50">
                {saveStatus === 'saving' && (
                  <div className="flex items-center text-blue-600 bg-blue-50 border border-blue-200 px-4 py-3 rounded-xl shadow-lg">
                    <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-blue-600 mr-3"></div>
                    <span className="font-medium">Salvando...</span>
                  </div>
                )}
                {saveStatus === 'success' && (
                  <div className="flex items-center text-green-600 bg-green-50 border border-green-200 px-4 py-3 rounded-xl shadow-lg">
                ...
                {saveStatus === 'error' && (
                  <div className="flex items-center text-red-600 bg-red-50 border border-red-200 px-4 py-3 rounded-xl shadow-lg">
                    <svg className="w-5 h-5 mr-3" fill="currentColor" viewBox="0 0 20 20">
