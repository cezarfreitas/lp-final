          ...
          <div className="text-center text-white px-4 max-w-4xl">
            ...
            <div className="mb-8 flex justify-center">
              <div className="bg-red-600 p-4 rounded-lg">
                <div className="text-white font-bold text-2xl">ECKO</div>
              </div>
            </div>
            ...
            {/* CTA Button */}
            <button className="border-2 border-red-600 text-white px-8 py-4 text-lg font-semibold hover:bg-red-600 transition-colors duration-300 flex items-center gap-2 mx-auto">
